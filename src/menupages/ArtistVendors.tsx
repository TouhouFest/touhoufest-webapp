...
const artistalley = "./src/images/artistalley.jpg";
const ace = "./src/images/artistalley/ace.png";
const tama = "./src/images/artistalley/tama.png";
const marlo = "./src/images/artistalley/MARLOWEMEMO.jpg";
const rustyhermit = "./src/images/artistalley/rustyhermit.jpg";
const asazei = "./src/images/artistalley/asazei.jpg";
const kurehii = "./src/images/artistalley/kurehii.jpg";
const haiyun = "./src/images/artistalley/haiyun.png";
const ckitten = "./src/images/artistalley/ckitten.jpg";
const codyyuki = "./src/images/artistalley/codyyuki.png";
const nono = "./src/images/artistalley/nono.jpg";
const gurugurumaru = "./src/images/artistalley/gurugurumaru.png";
const kuriarty = "./src/images/artistalley/kuriarty.jpg";
const fred = "./src/images/artistalley/fred.png";
const grillboss = "./src/images/artistalley/grillboss.jpg";
const birnam = "./src/images/artistalley/birnam.jpg";
const agi = "./src/images/artistalley/agi.png";
const meiki = "./src/images/artistalley/meiki.jpg";
const pumplin = "./src/images/artistalley/pumpking.jpg";
const siliconcat = "./src/images/artistalley/siliconcat.png";
const gruvysgudies = "./src/images/artistalley/gruvysgudies.jpg";
const xiaobbinc = "./src/images/artistalley/xiaobb.avif";
const essukaa = "./src/images/artistalley/essukaa.webp";
const anazel = "./src/images/artistalley/anazel.jpg";
const cookie = "./src/images/artistalley/cookie.png";
const freezeex = "./src/images/artistalley/freezeex.png";
const feeyaart = "./src/images/artistalley/feeyaart.jpg";
const leminigensokyo = "./src/images/artistalley/leminigensokyo.jpg";
const ruproject = "./src/images/artistalley/2ruproject.png";
const grapevines = "./src/images/artistalley/grapevines.png";
const brw = "./src/images/artistalley/BRW.jpg";
const neosanctum = "./src/images/artistalley/neosanctum.jpg";
const galaxianrecordings = "./src/images/artistalley/galaxianrecordings.png";
const twinphoenix = "./src/images/artistalley/TwinPhoenixInteractive.jpg";
const izakaya = "./src/images/artistalley/izakaya.jpg";
const entryplaza = "./src/images/entryplaza.jpg";
const cynicalfries = "./src/images/artistalley/cynicalfries.png";
const lyricalive = "./src/images/artistalley/lyricalive.png";
const maidacademy = "./src/images/artistalley/maidacademy.webp";
const popumai = "./src/images/artistalley/popumai.webp";
const loveboxf = "./src/images/artistalley/loveboxf.jpg";
const crescentia = "./src/images/artistalley/crescentia.jpg";
const youkaimountain = "./src/images/artistalley/youkaimountain.jpg";
const lemoncreme = "./src/images/artistalley/lemoncreme.webp";
const underworldizakaya = "./src/images/artistalley/underworldizakaya.jpg";
const andrewfm = "./src/images/artistalley/andrewfm.png";
const animelosangeles = "./src/images/artistalley/animelosangeles.jpg";
const bowersmuseum = "./src/images/artistalley/bowersmuseum.jpg";
const gensokyoradio = "./src/images/artistalley/gensokyoradio.jpg";
const idolmatsuri = "./src/images/artistalley/idolmatsuri.png";
const rosecityanifest = "./src/images/artistalley/rosecityanifest.jpg";
const roninexpo = "./src/images/artistalley/roninexpo.png";
const kotori = "./src/images/artistalley/kotori.jpg";
